...
public class RegistroHuesped extends JFrame {
	...
	private ReservaHuespedController reservaController = new ReservaHuespedController();
	...
	public RegistroHuesped() {
		...
		txtApellido.setBounds(560, 210, 285, 28);
		...
		txtNacionalidad = new JComboBox<Nacionalidad>();
		txtNacionalidad.setBounds(560, 350, 289, 36);
		txtNacionalidad.setBackground(SystemColor.text);
		txtNacionalidad.setFont(new Font("Roboto", Font.PLAIN, 16));
		
		txtNacionalidad.setModel(reservaController.getNationalityModel());
		...
		lblApellido.setBounds(560, 189, 255, 18);
		...
		lblTitulo.setBounds(595, 55, 245, 42);
		lblTitulo.setForeground(new Color(12, 138, 199));
		lblTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 23));
		contentPane.add(lblTitulo);
		
		JLabel lblNumeroReserva = new JLabel("Nro de reserva");
		...
		txtNreserva.setBounds(660, 495, 285, 33);
		txtNreserva.setColumns(10);
		txtNreserva.setEditable(false);
		txtNreserva.setBackground(Color.WHITE);
		txtNreserva.setBorder(BorderFactory.createEmptyBorder());
		txtNreserva.setText(reservaController.setNroReserva());
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				/*-----------------*/
				reservaController.validarCamposHuesped(txtNombre, txtApellido,
						txtFechaN, txtNacionalidad, txtTelefono);
				String nroReserva = txtNreserva.getText();
				
				reservaController.guardarDatosReserva(nroReserva);
				reservaController.guardarRegistroHuesped(nroReserva);
				Exito exitoMsg = new Exito();
				exitoMsg.setVisible(true);
				dispose();
			}
		});
